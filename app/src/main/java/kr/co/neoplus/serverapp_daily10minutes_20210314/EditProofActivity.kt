...
//            5글자 이상은 입력하게 해보자
            ...
            if (inputContent.length < 5) {
                Toast.makeText(mContext, "최소 5글자 이상은 입력해야 합니다", Toast.LENGTH_SHORT).show()
            }
            else {

//                 입력값을 서버에 인증글 작성 기능으로 전달 - 서버유틸 기능 필요

...
import kr.co.neoplus.serverapp_daily10minutes_20210314.adapters.ProofAdapter
...
//    인증글 목록이 담길 arraylist
    ...
    lateinit var mProofAdpater : ProofAdapter
...
//        mProofDate => String 으로 가공 (2020-06-09 등 양식) 해서 첨부
...
//        기존 게시글 싹 날리고 - 다시 새로 게시글을 목록에 추가
        mProofList.clear()
        ...
        runOnUiThread {
            mProofAdpater.notifyDataSetChanged()
        }
...
//        mProofDate 에는 기본적으로 현재 일시가 기록되어있다
...
//        리스트뷰 / 어댑터 연결
        mProofAdpater = ProofAdapter(mContext, R.layout.proof_list_item, mProofList)
        proofListView.adapter = mProofAdpater

//        조회 화면에 들어올 때 마다 - 오늘 날짜의 게시글을 불러오자 (자동새로고침)
